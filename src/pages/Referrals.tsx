    ...
    <div className="w-full animate-fade-in px-1 sm:px-0">
      ...
      <div className="bg-card border border-border rounded-2xl p-5 shadow-card mb-5">
        ...
        <ol className="space-y-2.5 text-[13px] text-foreground">
          ...
          <li className="flex gap-3"><span className="w-6 h-6 rounded-full bg-primary-tint text-primary font-bold text-[12px] flex items-center justify-center shrink-0">3</span> You instantly earn <strong>100 coins</strong> for Standard (₦6.5k) or <strong>200 coins</strong> for Premium (₦20k).</li>
        </ol>
      </div>
