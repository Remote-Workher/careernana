...
const PLAN_DETAILS: Record<PlanId, {
  ...
  trial: {
    ...
    features: [
      { label: "Full access to Remote Workher", included: true },
      { label: "100 AI coins every month", included: true },
      { label: "Up to 3 resource downloads per month", included: true },
  ...
  quarterly: {
    ...
    coins: 200,
    coinsCadence: "200 coins / month",
    features: [
      { label: "Everything on Remote Workher", included: true },
      { label: "200 AI coins every month", included: true },
      { label: "Unlimited resource downloads", included: true },
      { label: "Full job board, My Plan, Brag File & Challenges", included: true },
      { label: "Cancel anytime — no auto-renew", included: true },
    ],
  },
