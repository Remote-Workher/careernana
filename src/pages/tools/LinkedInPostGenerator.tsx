            ...
            >
              ...
              <div className="p-5">
                <textarea
                  ...
                  className="w-full min-h-[480px] px-4 py-4 rounded-[9px] border border-[#EBE6E2] text-[13px] text-foreground leading-[1.7] resize-none focus:outline-none focus:border-[#0A66C2] transition-colors whitespace-pre-wrap"
