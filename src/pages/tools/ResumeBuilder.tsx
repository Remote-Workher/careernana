...
export default function ResumeBuilder() {
  ...
  const generateStyledPdfBlob = async (): Promise<Blob> => {
    ...
    // Render the resume off-screen at a fixed A4 width so mobile produces
    // the exact same PDF layout as desktop. Without this, html2canvas
    // captures the narrow mobile viewport (often resulting in blank or
    // clipped output on small screens).
    ...
    try {
      // Give the clone a tick to lay out
