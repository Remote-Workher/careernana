...
import { Search, Heart, Sparkles, Crown, Menu, X, UserCog, ArrowRight, Bell, Play } from "lucide-react";
  ...
  return (
    <div className="rwh-hub min-h-screen bg-background font-[DM_Sans,sans-serif] text-foreground">
      ...
      <div className="flex min-h-[calc(100vh-58px)]">
        ...
        {/* MAIN */}
        <main className={`flex-1 min-w-0 ${isAuthed ? "pb-4 md:pb-0" : ""}`}>
          {/* HERO */}
            ...
            return (
              <div className="bg-white border-b border-[#ebe6e2] px-4 sm:px-6 md:px-8 py-5">
                ...
                <div className="jobs-scroll flex gap-2.5 overflow-x-auto pb-1 sm:grid sm:grid-cols-3 md:grid-cols-6 sm:overflow-visible">
                  {(isAuthed
                    ? [
                        { icon: "📄", name: "Build your resume", desc: "Tailored in minutes", cls: "ci-pink", route: "/tools/resume" },
