  ...
  if (result) {
    ...
    return (
      <div className="bg-card rounded-xl border border-border">
        ...
        {/* Download Modal */}
        {showDownloadModal && (
          <div className="fixed inset-0 z-50 bg-black/60 flex items-end sm:items-center justify-center p-0 sm:p-4" onClick={() => setShowDownloadModal(false)}>
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-4 sm:p-5">
      ...
      <p className="text-[10px] text-muted-foreground mt-2 text-center">
        Uses your profile & my wins automatically
      </p>
    </div>
  );
}
