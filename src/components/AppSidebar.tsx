    ...
    <aside className="w-[210px] h-full bg-card border-r border-border flex flex-col font-sans">
      ...
      <div className="p-3 border-t border-border">
        <div className="bg-foreground border border-foreground rounded-xl p-3.5">
          <Crown className="w-5 h-5 text-primary-light mb-1" />
          ...
          <button
            ...
            className="w-full py-2 bg-primary text-primary-foreground rounded-lg text-xs font-semibold hover:bg-primary-dark transition-colors"
          >
            Join now →
          </button>
          <div className="text-[10px] text-background/50 text-center mt-1.5">Cancel anytime</div>
        </div>
        {userName && (
          <button
